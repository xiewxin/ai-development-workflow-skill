...
- 目前對話、已載入能力、倉庫規範或活動產物顯示外部工作流時：[`references/workflow-integration.md`](references/workflow-integration.md)
...
- 只依目前對話、平台已載入能力、倉庫規範與可定位的活動產物判斷是否啟用整合。只有名稱、已安裝工具或目錄存在不構成啟用證據。
